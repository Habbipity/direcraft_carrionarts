...
public class MattockItem extends DiggerItem{
	...
	public static final TagKey<Block> MINEABLE_WITH_MATTOCK_TAG = TagKey.create(
	        Registries.BLOCK,
	        ResourceLocation.fromNamespaceAndPath("direcraft", "mineable/mattock")
		);	
	
	public MattockItem(Tier tier, Properties properties) {
		super(tier, MINEABLE_WITH_MATTOCK_TAG, properties);
	}
	
    @Override
    public boolean canPerformAction(ItemStack stack, ItemAbility itemAbility) {
        return ItemAbilities.DEFAULT_AXE_ACTIONS.contains(itemAbility) || ItemAbilities.DEFAULT_PICKAXE_ACTIONS.contains(itemAbility);
    }
